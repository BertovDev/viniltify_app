...
import { useGLTF, PerspectiveCamera, Box,SpotLight, PresentationControls, OrbitControls } from '@react-three/drei'
...
// function setMyVinilPlay(vinilPlay,setVinylPlay){
...
export function Model2({vinylPlay,setVinylPlay,props}) {
  ...
  console.log("VINIYL IN MODEL", vinylPlay)
  ...
  return (
      ...
      <group {...props} dispose={null}>
        ...
        {/* <pointLight intensity={0.3} decay={2} position={[-0.79, 1.04, 0.92]} rotation={[-Math.PI / 2, 0, 0]} /> */}
