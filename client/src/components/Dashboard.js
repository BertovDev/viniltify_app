...
// Icons
import { Coin, Github, Linkedin, Twitter, WindowFullscreen } from "react-bootstrap-icons";
  ...
  return (
    <>
      <Container
        ...
        >
          ...
          <Modal.Body>
            ...
            <p>
              Maintain left click to move the scene or use the mouse wheel to
              zoom!
            </p>
            <hr />
            <h4>Select a song</h4>
        ...
        >
          <Col style={{padding:"5px 12px", color: "white", fontSize: "16px", fontFamily: "monospace" }}>
          ...
          <a
            ...
            target="_blank"
          >
            <Github color="white" size={window.mobileCheck() ? 20 : 25} />
          </a>
          <a
            ...
            target="_blank"
          >
            <Linkedin color="white" size={window.mobileCheck() ? 20 : 25} />
          </a>
          <a
            style={{ padding: "0 10px" }}
            ...
            target="_blank"
          >
            <Twitter color="white" size={window.mobileCheck() ? 20 : 25} />
          </a>
          </Col> */}
        </Row>
      </Container>
      ...
      <Loader
        ...
        `} // Text
        innerStyles={{ fontSize: loaderFontSize,display:"flex",justifyContent: "center",alignItems:"center",width:"100%"}}
      />
    </>
  );
}
